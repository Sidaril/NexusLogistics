...
public class MyCornerComboBox : MonoBehaviour
{
    ...
    public static void InitBaseObject()
    {
        ...
        foreach (var button in ((System.Collections.Generic.List<UnityEngine.UI.Button>)typeof(UIComboBox).GetField("ItemButtons", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic).GetValue(cbctrl)))
        {
            Destroy(button.gameObject);
        }
        cbctrl.Items.Clear();
        ((System.Collections.Generic.List<UnityEngine.UI.Button>)typeof(UIComboBox).GetField("ItemButtons", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic).GetValue(cbctrl)).Clear();
        _baseObject = go;
    }
    ...
    public void SetFontSize(int size)
    {
        ...
        ((System.Collections.Generic.List<UnityEngine.UI.Button>)typeof(UIComboBox).GetField("ItemButtons", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic).GetValue(_comboBox)).ForEach(b => b.GetComponentInChildren<Text>().fontSize = size);
        _comboBox.m_ListItemRes.GetComponentInChildren<Text>().fontSize = size;
    }

    public void SetItems(params string[] items)
    {
        _comboBox.Items = items.Select(s => s.Translate()).ToList();
